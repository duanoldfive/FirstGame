...
namespace UnityEditor
{
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent useRoadMap = EditorGUIUtility.TrTextContent("Use Road Map",
                "Specifies the road Material and/or Color of the surface.");
            public static readonly GUIContent useRoadMapArray = EditorGUIUtility.TrTextContent("Use Road Map Array",
                "Specifies the road Material and/or Color of the surface.");

            public static readonly GUIContent roadMap = EditorGUIUtility.TrTextContent("Road Map",
                "Specifies the road Material and/or Color of the surface.");
            public static readonly GUIContent roadMapArray = EditorGUIUtility.TrTextContent("Road Map Array",
                "Specifies the road Material and/or Color of the surface.");
        }
