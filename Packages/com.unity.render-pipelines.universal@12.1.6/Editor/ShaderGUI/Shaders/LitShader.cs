...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class LitShader : BaseShaderGUI
    {
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            DrawFloatToggleProperty(Styles.useRoadMap, litProperties.useRoad);
            DrawFloatToggleProperty(Styles.useRoadMapArray, litProperties.useRoadArray);
            materialEditor.TexturePropertySingleLine(Styles.roadMap, litProperties.roadMap);
            materialEditor.TexturePropertySingleLine(Styles.roadMapArray, litProperties.roadMapArray);
        }
